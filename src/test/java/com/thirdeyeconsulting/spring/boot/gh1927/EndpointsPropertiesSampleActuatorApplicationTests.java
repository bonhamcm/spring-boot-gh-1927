...
public class EndpointsPropertiesSampleActuatorApplicationTests {
    ...
    public void testCustomErrorPath() throws Exception {
        ...
        ResponseEntity<Map> entity = new TestRestTemplate("user", "password").getForEntity("http://localhost:" + this.port
                + "/oops", Map.class);
    ...
    public void testCustomContextPath() throws Exception {
        ResponseEntity<String> entity = new TestRestTemplate().getForEntity("http://localhost:" + this.port + "/admin/health",
                String.class);
